                      ...
                      entrylk_cmd cmd, entrylk_type type, dict_t * xdata)
{
    ...
    ec_entrylk(frame, this, -1, fop_flags, default_entrylk_cbk, NULL,
                       ...
                       entrylk_cmd cmd, entrylk_type type, dict_t * xdata)
{
    ...
    if (cmd == ENTRYLK_UNLOCK)
            fop_flags = EC_MINIMUM_ONE;
    ec_fentrylk(frame, this, -1, fop_flags, default_fentrylk_cbk, NULL,
                ...
                const char *name, dict_t *xdata)
{
        int     error = 0;
        ec_t    *ec = this->private;
        uint32_t fop_flags = EC_MINIMUM_MIN;
        ...
        ec_getxattr (frame, this, -1, fop_flags, default_getxattr_cbk,
                     NULL, loc, name, xdata);
                 ...
                 int32_t cmd, struct gf_flock * flock, dict_t * xdata)
{
    ...
    if (flock->l_type == F_UNLCK)
            fop_flags = EC_MINIMUM_ONE;
    ec_lk(frame, this, -1, fop_flags, default_lk_cbk, NULL, fd, cmd,
          flock, xdata);
