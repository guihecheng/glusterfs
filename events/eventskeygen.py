...
keys = (
    ...
    #xquota events
    "EVENT_XQUOTA_ENABLE",
    "EVENT_XQUOTA_DISABLE",
    "EVENT_XQUOTA_PROJECT_LIMIT_USAGE",
    "EVENT_XQUOTA_PROJECT_REMOVE_USAGE",
    "EVENT_XQUOTA_ALERT_TIME",
    "EVENT_XQUOTA_SOFT_TIMEOUT",
    "EVENT_XQUOTA_HARD_TIMEOUT",
    "EVENT_XQUOTA_DEFAULT_SOFT_LIMIT",
    "EVENT_IMPORT_XQUOTA_CONF_FAILED",
    #xquota async events
    "EVENT_XQUOTA_CROSSED_SOFT_LIMIT",
)
