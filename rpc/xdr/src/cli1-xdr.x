...
enum gf_xquota_type {
        GF_XQUOTA_OPTION_TYPE_NONE = 0,
        GF_XQUOTA_OPTION_TYPE_ENABLE,
        GF_XQUOTA_OPTION_TYPE_DISABLE,
        GF_XQUOTA_OPTION_TYPE_PROJECT_LIMIT_USAGE,
        GF_XQUOTA_OPTION_TYPE_PROJECT_REMOVE_USAGE,
        GF_XQUOTA_OPTION_TYPE_PROJECT_LIST_USAGE,
        GF_XQUOTA_OPTION_TYPE_VERSION,
        GF_XQUOTA_OPTION_TYPE_ALERT_TIME,
        GF_XQUOTA_OPTION_TYPE_SOFT_TIMEOUT,
        GF_XQUOTA_OPTION_TYPE_HARD_TIMEOUT,
        GF_XQUOTA_OPTION_TYPE_DEFAULT_SOFT_LIMIT,
        GF_XQUOTA_OPTION_TYPE_UPGRADE,
        GF_XQUOTA_OPTION_TYPE_MAX
};
...
enum gf_cli_status_type {
        ...
        GF_CLI_STATUS_XQUOTAD      = 0x040000     /*1000000000000000000*/
};
