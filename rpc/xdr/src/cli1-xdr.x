...
enum gf_quota_type {
        ...
        GF_QUOTA_OPTION_TYPE_DISABLE_USER,
        GF_QUOTA_OPTION_TYPE_LIMIT_USAGE_USER,
        GF_QUOTA_OPTION_TYPE_REMOVE_USAGE_USER,
        GF_QUOTA_OPTION_TYPE_LIST_USER,
        GF_QUOTA_OPTION_TYPE_ENABLE_GROUP,
        GF_QUOTA_OPTION_TYPE_DISABLE_GROUP,
        GF_QUOTA_OPTION_TYPE_LIMIT_USAGE_GROUP,
        GF_QUOTA_OPTION_TYPE_REMOVE_USAGE_GROUP,
        GF_QUOTA_OPTION_TYPE_LIST_GROUP,
